...
export default function ContactPage() {
  ...
  const submit = () => {
    const newErrors: ErrorState = { name: "", email: "", message: "" };
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .success-p { font-size: 14px; color: var(--dark); opacity: .7; line-height: 1.75; max-width: 340px; }
        .success-back {
        ...
        .hours-title::before { content: ''; width: 4px; height: 20px; background: var(--orange); display: block; flex-shrink: 0; }
        .h-row {
        ...
        .social-block { margin-top: auto; padding-top: 22px; border-top: 1px solid rgba(255,255,255,.1); }
        .social-lbl {
          font-family: 'Barlow Condensed', sans-serif;
          font-size: 9px; font-weight: 800; letter-spacing: .18em; text-transform: uppercase;
      ...
      <div className="cp">
        ...
        {/* ── HERO ── */}
        <div className="hero" ref={header.ref}>

          {/* LEFT */}
          <div className="hero-left">
            <div className="hero-left-inner">
              <div className="hl-eyebrow">Contact Us</div>
              <h1 className="hl-h1">We're Here<br/>To <i>Help You.</i></h1>
              <p className="hl-sub">
            ...
            <div className="hero-right-inner">
              {sent ? (
                <div className="success">
                  ...
                  <p className="success-p">Thanks for reaching out. Our team will get back to you within 2 hours.</p>
                ...
                <>
                  ...
                  <div className="fgrid">
                    <div className="fg">
                      ...
                      <input className={`fi${errors.name ? " err" : ""}`} placeholder="Your full name" value={form.name} onChange={e => handleChange("name", e.target.value)} />
                    </div>
                    <div className="fg">
                      <label className="flbl">Email <span className="ferr">{errors.email}</span></label>
                      <input className={`fi${errors.email ? " err" : ""}`} placeholder="you@email.com" value={form.email} onChange={e => handleChange("email", e.target.value)} />
                    </div>
                  </div>

                  <div className="fg">
                    <label className="flbl">Phone</label>
                    <input className="fi" placeholder="+91 00000 00000" value={form.phone} onChange={e => handleChange("phone", e.target.value)} />
                  </div>

                  <div className="fg">
                    <label className="flbl">Message <span className="ferr">{errors.message}</span></label>
                    <textarea className={`fta${errors.message ? " err" : ""}`} placeholder="Tell us how we can help…" value={form.message} onChange={e => handleChange("message", e.target.value)} />
                  </div>
