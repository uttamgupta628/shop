          ...
          <div className="lg:col-span-3">
            <div className="bg-white">
              ...
              {activeSection === 'returns' && (
                <div className="text-center py-16">
                  <h2 className="text-xl font-semibold text-gray-900 mb-4">My Returns</h2>
                  <p className="text-gray-500">View your return history</p>
                </div>
              )}

              {activeSection === 'cancellations' && (
                <div className="text-center py-16">
                  <h2 className="text-xl font-semibold text-gray-900 mb-4">My Cancellations</h2>
                  <p className="text-gray-500">View your cancelled orders</p>
                </div>
              )}
            </div>
          </div>
